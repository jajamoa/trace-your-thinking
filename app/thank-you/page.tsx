...
export default function ThankYouPage() {
  ...
  return (
    <motion.div
      ...
      className="container mx-auto px-4 py-24 flex flex-col items-center justify-center min-h-screen text-center relative"
    >
      <Confetti />
      ...
      >
        ...
        <div className="text-lg text-gray-600 mb-6 leading-relaxed font-light">
          <p className="mb-4">
