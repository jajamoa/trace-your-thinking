...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen relative bg-[#f5f2eb] px-4 py-16">
      <motion.div
      ...
      >
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-subtle border border-[#e0ddd5]">
          <h1 className="text-3xl font-light mb-8 text-[#333333]">About This Study</h1>
          ...
          <div className="space-y-6 text-gray-700 leading-relaxed">
            ...
            <div className="py-4 px-6 bg-[#f5f2eb] rounded-lg border border-[#e0ddd5]">
              <p className="text-sm">
            ...
            <div className="pt-6 border-t border-[#e0ddd5]">
              <h2 className="text-xl font-light mb-4 text-[#333333]">Contact Information</h2>
              <p>
