  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-10">
        <Button variant="ghost" onClick={() => router.push("/interview")} className="text-gray-600 hover:text-gray-900">
      ...
      <Dialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => {
                  setConfirmProlificId(e.target.value)
                  setConfirmError("")
                }}
          ...
          <DialogFooter className="flex justify-between sm:justify-between">
            ...
            <Button type="button" onClick={handleConfirmIdCheck} className="bg-[#333333] hover:bg-[#222222] text-white">
              Confirm & Submit
            </Button>
          </DialogFooter>
        </DialogContent>
